...
export function BottomNav({ homeHref }: { homeHref: string }) {
  ...
  const showHistory = pathname === "/kasir/transaksi/baru";
        ...
        <nav className="relative flex h-14 items-center justify-center text-sm">
          ...
          {showHistory ? (
            <Link
              href="/kasir/riwayat"
              prefetch={false}
              className="absolute right-0 inline-flex h-10 w-10 items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-700 transition hover:border-zinc-300 hover:bg-zinc-50 hover:text-zinc-900"
