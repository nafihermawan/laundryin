  ...
  return (
    <div id="embed-root" className="w-full">
      ...
      <div className="w-full rounded-2xl border border-zinc-200 bg-white shadow-xl">
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-zinc-100 bg-white p-5">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  ...
                  >
                    {order.status === "diproses" ? "Diterima" : order.status === "siap" ? "Siap Diambil" : order.status === "diambil" ? "Sudah Diambil" : "Diterima"}
                  </span>
                  <span
                    className={`inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-medium ${
                      isPaid
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-xl border border-zinc-100 bg-zinc-50 px-3 py-2">
                  ...
                  <div className="mt-1 text-sm font-medium text-zinc-900">{order.due_at ? formatDate(order.due_at) : "-"}</div>
                </div>
              </div>
